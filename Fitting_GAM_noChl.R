...
#
    ...
    if("tar_0.5" %in% sampling) {
      print("Fitting GAM-Pref0.5_nochl")
    ...
    if("tar_0.6" %in% sampling) {
      print("Fitting GAM-Pref0.6_nochl")
    ...
    if("tar_0.7" %in% sampling) {
      print("Fitting GAM-Pref0.7_nochl")
    ...
    if("tar_0.8" %in% sampling) {
      print("Fitting GAM-Pref0.8_nochl")
    ...
    if("tar_0.9" %in% sampling) {
      print("Fitting GAM-Pref0.9_nochl")
