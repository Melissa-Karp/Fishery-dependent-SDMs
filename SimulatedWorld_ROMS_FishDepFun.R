...
dir <- "C:/R scripts/Steph WRAP/hadley/"  #*** james
...
SimulateWorld_ROMS_PMP <- function(dir, nsamples){
  ...
  dist_to_ports<-read.csv("Dist_to_Ports.csv")
  ...
  for (y in 1:121){
    ...
    # *** you probably want to rescale utility between 0 and 1, bc the positive and negative values might act strangely
