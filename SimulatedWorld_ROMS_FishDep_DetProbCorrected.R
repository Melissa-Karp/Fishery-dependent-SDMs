...
SimulateWorld_ROMS_FishDepFun_DetProbCorrection <- function(dir, nsamples){
...
#---- ASSIGN RESPONSE CURVES ---- ####
 ...
 ###-----SAMPLE PRESENCES AND ABSENCES-----#####
    ...
    presence.points.random <- sampleOccurrences(suitability_PA,n = nsamples,type = "presence-absence",
                                                detection.probability = 1, correct.by.suitability=TRUE, error.probability=0, plot = TRUE,
    ...
    presence.points.pref<-sampleOccurrences(suitability_PA, n=nsamples, type="presence-absence",
                                            detection.probability = 1, correct.by.suitability=TRUE, bias = "manual", weights = Tar_reclassify, plot = TRUE)
    #convert to dataframe
    ...
    presence.points.dist<-sampleOccurrences(suitability_PA, n=nsamples, type="presence-absence",
                                            detection.probability = 1, correct.by.suitability=TRUE, bias = "manual", weights= Dist_reclassify, plot = TRUE)
    #convert to dataframe
    ...
    presence.points.Bycatch<-sampleOccurrences(suitability_PA, n=nsamples, type="presence-absence",
                                               detection.probability = 1, correct.by.suitability=TRUE, bias = "manual", weights= By_reclassify, plot = TRUE)
    #convert to dataframe
    ...
    presence.points.ByDist<-sampleOccurrences(suitability_PA, n=nsamples, type="presence-absence",
                                              detection.probability = 1, correct.by.suitability=TRUE, bias = "manual", weights= ByDist_reclassify, plot = TRUE)
    #convert to dataframe
...
#test<-SimulateWorld_ROMS_FishDepFun_DetProbCorrection(dir=dir, nsamples = 100)
