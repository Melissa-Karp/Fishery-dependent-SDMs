...
## this uses a different configuration for space-time tensor than the GAM_SpaceTime.R uses
...
if("ran" %in% sampling){
  ...
  gam_Ran_Pte <- gam(pres~s(temp) + s(mld) + s(chl_surface) + te(lat, lon, year, d=c(2,1), bs=c('ds','cr'), m=c(1,.5), k=c(30,10)), data=dat_hist_random, family=binomial) #note - chl-surface is log of chl-surface
  #plot(gam_Ran_Pte, pages=1)
  gam_Ran_Nte <- gam(log_abundance~s(temp)+ s(mld) + s(chl_surface) + te(lat, lon, year, d=c(2,1), bs=c('ds','cr'), m=c(1,.5), k=c(30,10)), data=dat_hist_random[dat_hist_random$abundance>0,], family=gaussian)
...
if("tar_0.5" %in% sampling) {
  ...
  gam_Tar_P_1te<- gam(pres~s(temp)+ s(mld) + s(chl_surface) + te(lat, lon, year, d=c(2,1), bs=c('ds','cr'), m=c(1,.5), k=c(30,10)), data=dat_hist_Tar_1, family=binomial)
  #plot(gam_Tar_P_1te, pages=1)
  gam_Tar_N_1te <- gam(log_abundance~s(temp)+ s(mld) + s(chl_surface)+ te(lat, lon, year, d=c(2,1), bs=c('ds','cr'), m=c(1,.5), k=c(30,10)), data=dat_hist_Tar_1[dat_hist_Tar_1$abundance>0,], family=gaussian)
...
if("tar_0.6" %in% sampling) {
  ...
  gam_Tar_P_2te <- gam(pres~s(temp)+ s(mld) + s(chl_surface)+ te(lat, lon, year, d=c(2,1), bs=c('ds','cr'), m=c(1,.5), k=c(30,10)), data=dat_hist_Tar_2, family=binomial)
  #plot(gam_Tar_P_2te, pages=1)
  gam_Tar_N_2te <- gam(log_abundance~s(temp)+ s(mld) + s(chl_surface)+ te(lat, lon, year, d=c(2,1), bs=c('ds','cr'), m=c(1,.5), k=c(30,10)), data=dat_hist_Tar_2[dat_hist_Tar_2$abundance>0,], family=gaussian)
...
if("tar_0.7" %in% sampling) {
  ...
  gam_Tar_P_3te <- gam(pres~s(temp)+ s(mld) + s(chl_surface) + te(lat, lon, year, d=c(2,1), bs=c('ds','cr'), m=c(1,.5), k=c(30,10)), data=dat_hist_Tar_3, family=binomial)
  #plot(gam_Tar_P_3te, pages=1)
  gam_Tar_N_3te <- gam(log_abundance~s(temp)+ s(mld) + s(chl_surface)+ te(lat, lon, year, d=c(2,1), bs=c('ds','cr'), m=c(1,.5), k=c(30,10)), data=dat_hist_Tar_3[dat_hist_Tar_3$abundance>0,], family=gaussian)
...
if("tar_0.8" %in% sampling) {
  ...
  gam_Tar_P_4te <- gam(pres~s(temp)+ s(mld) + s(chl_surface) + te(lat, lon, year, d=c(2,1), bs=c('ds','cr'), m=c(1,.5), k=c(30,10)), data=dat_hist_Tar_4, family=binomial)
  #plot(gam_Tar_P_4te, pages=1)
  gam_Tar_N_4te <- gam(log_abundance~s(temp)+ s(mld) + s(chl_surface) + te(lat, lon, year, d=c(2,1), bs=c('ds','cr'), m=c(1,.5), k=c(30,10)), data=dat_hist_Tar_4[dat_hist_Tar_4$abundance>0,], family=gaussian)
...
if("tar_0.9" %in% sampling) {
  ...
  gam_Tar_P_5te <- gam(pres~s(temp)+ s(mld) + s(chl_surface) + te(lat, lon, year, d=c(2,1), bs=c('ds','cr'), m=c(1,.5), k=c(30,10)), data=dat_hist_Tar_5, family=binomial)
  #plot(gam_Tar_P_5te, pages=1)
  gam_Tar_N_5te <- gam(log_abundance~s(temp)+ s(mld) + s(chl_surface) + te(lat, lon, year, d=c(2,1), bs=c('ds','cr'), m=c(1,.5), k=c(30,10)), data=dat_hist_Tar_5[dat_hist_Tar_5$abundance>0,], family=gaussian)
...
if("npo" %in% sampling){
  ...
  gam_Dist_P_npote <- gam(pres~s(temp) + s(mld) + s(chl_surface) + te(lat, lon, year, d=c(2,1), bs=c('ds','cr'), m=c(1,.5), k=c(30,10)), data=dat_hist_Dist_npo, family=binomial)
  #plot(gam_Dist_P_npote, pages=1)
  gam_Dist_N_npote <- gam(log_abundance~s(temp) + s(mld) + s(chl_surface) + te(lat, lon, year, d=c(2,1), bs=c('ds','cr'), m=c(1,.5), k=c(30,10)), data=dat_hist_Dist_npo[dat_hist_Dist_npo$abundance>0,], family=gaussian)
...
if("npn" %in% sampling){
  ...
  gam_Dist_P_npnte <- gam(pres~s(temp) + s(mld) + s(chl_surface) + te(lat, lon, year, d=c(2,1), bs=c('ds','cr'), m=c(1,.5), k=c(30,10)), data=dat_hist_Dist_npn, family=binomial)
  #plot(gam_Dist_P_npnte, pages=1)
  gam_Dist_N_npnte <- gam(log_abundance~s(temp) + s(mld) + s(chl_surface) + te(lat, lon, year, d=c(2,1), bs=c('ds','cr'), m=c(1,.5), k=c(30,10)), data=dat_hist_Dist_npn[dat_hist_Dist_npn$abundance>0,], family=gaussian)
...
if("mpo" %in% sampling){
  ...
  gam_Dist_P_mpote <- gam(pres~s(temp) + s(mld) + s(chl_surface)+ te(lat, lon, year, d=c(2,1), bs=c('ds','cr'), m=c(1,.5), k=c(30,10)), data=dat_hist_Dist_mpo, family=binomial)
  #plot(gam_Dist_P_mpote, pages=1)
  gam_Dist_N_mpote <- gam(log_abundance~s(temp) + s(mld) + s(chl_surface)+ te(lat, lon, year, d=c(2,1), bs=c('ds','cr'), m=c(1,.5), k=c(30,10)), data=dat_hist_Dist_mpo[dat_hist_Dist_mpo$abundance>0,], family=gaussian)
...
if("mpn" %in% sampling){
  ...
  gam_Dist_P_mpnte <- gam(pres~s(temp) + s(mld) + s(chl_surface) + te(lat, lon, year, d=c(2,1), bs=c('ds','cr'), m=c(1,.5), k=c(30,10)), data=dat_hist_Dist_mpn, family=binomial)
  #plot(gam_Dist_P_mpnte, pages=1)
  gam_Dist_N_mpnte <- gam(log_abundance~s(temp) + s(mld) + s(chl_surface) + te(lat, lon, year, d=c(2,1), bs=c('ds','cr'), m=c(1,.5), k=c(30,10)), data=dat_hist_Dist_mpn[dat_hist_Dist_mpn$abundance>0,], family=gaussian)
...
if("spo" %in% sampling){
  ...
  gam_Dist_P_spote <- gam(pres~s(temp) + s(mld) + s(chl_surface)+ te(lat, lon, year, d=c(2,1), bs=c('ds','cr'), m=c(1,.5), k=c(30,10)), data=dat_hist_Dist_spo, family=binomial)
  #plot(gam_Dist_P_spote, pages=1)
  gam_Dist_N_spote <- gam(log_abundance~s(temp) + s(mld) + s(chl_surface)+ te(lat, lon, year, d=c(2,1), bs=c('ds','cr'), m=c(1,.5), k=c(30,10)), data=dat_hist_Dist_spo[dat_hist_Dist_spo$abundance>0,], family=gaussian)
...
if("spn" %in% sampling){
  ...
  gam_Dist_P_spnte <- gam(pres~s(temp) + s(mld) + s(chl_surface)+ te(lat, lon, year, d=c(2,1), bs=c('ds','cr'), m=c(1,.5), k=c(30,10)), data=dat_hist_Dist_spn, family=binomial)
  #plot(gam_Dist_P_spnte, pages=1)
  gam_Dist_N_spnte <- gam(log_abundance~s(temp) + s(mld) + s(chl_surface)+ te(lat, lon, year, d=c(2,1), bs=c('ds','cr'), m=c(1,.5), k=c(30,10)), data=dat_hist_Dist_spn[dat_hist_Dist_spn$abundance>0,], family=gaussian)
...
if("allo" %in% sampling){
  ...
  gam_Dist_P_allote <- gam(pres~s(temp) + s(mld) + s(chl_surface) + te(lat, lon, year, d=c(2,1), bs=c('ds','cr'), m=c(1,.5), k=c(30,10)), data=dat_hist_Dist_allo, family=binomial)
  #plot(gam_Dist_P_allote, pages=1)
  gam_Dist_N_allote <- gam(log_abundance~s(temp) + s(mld) + s(chl_surface) + te(lat, lon, year, d=c(2,1), bs=c('ds','cr'), m=c(1,.5), k=c(30,10)), data=dat_hist_Dist_allo[dat_hist_Dist_allo$abundance>0,], family=gaussian)
...
if("alln" %in% sampling){
  ...
  gam_Dist_P_allnte <- gam(pres~s(temp) + s(mld) + s(chl_surface) + te(lat, lon, year, d=c(2,1), bs=c('ds','cr'), m=c(1,.5), k=c(30,10)), data=dat_hist_Dist_alln, family=binomial)
  #plot(gam_Dist_P_allnte, pages=1)
  gam_Dist_N_allnte <- gam(log_abundance~s(temp) + s(mld) + s(chl_surface) + te(lat, lon, year, d=c(2,1), bs=c('ds','cr'), m=c(1,.5), k=c(30,10)), data=dat_hist_Dist_alln[dat_hist_Dist_alln$abundance>0,], family=gaussian)
...
if("BY" %in% sampling){
  ...
  gam_BY_Pte <- gam(pres~s(temp) + s(mld) + s(chl_surface) + te(lat, lon, year, d=c(2,1), bs=c('ds','cr'), m=c(1,.5), k=c(30,10)), data=dat_hist_BY, family=binomial)
  #plot(gam_BY_Pte, pages=1)
  gam_BY_Nte <- gam(log_abundance~s(temp) + s(mld) + s(chl_surface) + te(lat, lon, year, d=c(2,1), bs=c('ds','cr'), m=c(1,.5), k=c(30,10)), data=dat_hist_BY[dat_hist_BY$abundance>0,], family=gaussian)
...
if("CA_sm" %in% sampling) {
  ...
  gam_CA_P_smte <- gam(pres~s(temp) + s(mld) + s(chl_surface) + te(lat, lon, year, d=c(2,1), bs=c('ds','cr'), m=c(1,.5), k=c(30,10)), data=dat_hist_CA_sm, family=binomial)
  #plot(gam_CA_P_smte, pages=1)
  gam_CA_N_smte <- gam(log_abundance~s(temp) + s(mld) + s(chl_surface) + te(lat, lon, year, d=c(2,1), bs=c('ds','cr'), m=c(1,.5), k=c(30,10)), data=dat_hist_CA_sm[dat_hist_CA_sm$abundance>0,], family=gaussian)
...
if("CA_med" %in% sampling) {
  ...
  gam_CA_P_medte <- gam(pres~s(temp) + s(mld) + s(chl_surface) + te(lat, lon, year, d=c(2,1), bs=c('ds','cr'), m=c(1,.5), k=c(30,10)), data=dat_hist_CA_med, family=binomial)
  #plot(gam_CA_P_medte, pages=1)
  gam_CA_N_medte <- gam(log_abundance~s(temp) + s(mld) + s(chl_surface) + te(lat, lon, year, d=c(2,1), bs=c('ds','cr'), m=c(1,.5), k=c(30,10)), data=dat_hist_CA_med[dat_hist_CA_med$abundance>0,], family=gaussian)
...
if("CA_lar" %in% sampling) {
  ...
  gam_CA_P_larte <- gam(pres~s(temp) + s(mld) + s(chl_surface) + te(lat, lon, year, d=c(2,1), bs=c('ds','cr'), m=c(1,.5), k=c(30,10)), data=dat_hist_CA_lar, family=binomial)
  #plot(gam_CA_P_larte, pages=1)
  gam_CA_N_larte <- gam(log_abundance~s(temp) + s(mld) + s(chl_surface) + te(lat, lon, year, d=c(2,1), bs=c('ds','cr'), m=c(1,.5), k=c(30,10)), data=dat_hist_CA_lar[dat_hist_CA_lar$abundance>0,], family=gaussian)
